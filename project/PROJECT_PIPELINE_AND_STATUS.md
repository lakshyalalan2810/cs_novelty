...
- the preserved V1 220-run holdout remains unchanged;
- the corrected V3 200-run paired holdout uses unused seeds `29026–29030`, after clean-validation calibration was frozen;
...
| 6 | `06_final_evaluation.ipynb` | Load a fixed controller configuration and run the preserved paired V1 A/B/C/D final matrix. |
| V2/V3 | `04d_auxiliary_virtual_sensor.ipynb`, `04e_dual_virtual_sensor_arbitration.ipynb` | Add independent auxiliary recovery evidence, then correct and evaluate deterministic dual-virtual-sensor arbitration. |
